...
export function buildClientWorld(setup: Setup): World {
  ...
  world.teams = setup.teams.map((t) => ({
    ...
    soldierIds: [], leaderId: -1, post: null, volleyCD: 0, march: null,
  }));
  return world;
}
...
function makeSoldier(id: number, teamId: number, faction: Faction): Soldier {
  ...
  return {
    ...
    targetId: null, targetVehId: null, manualTargetId: null, manualVehId: null, fireCell: null, fireSmoke: false, smokeAmmo: 0,
    ambushTimer: 0, fireCD: 0, firedTimer: 0, setupTime: 0, meleeCD: 0, grenades: 0, grenadeCD: 0,
